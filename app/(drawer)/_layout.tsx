    ...
    const CustomDrawerComponent = (props) => {
        return (
            <DrawerContentScrollView {...props}>
                ...
                <DrawerItem onPress={() => {router.navigate('/(drawer)/receipt') }} label='Receipt' icon={(props) => (<DrawerIcon color='olive' name='bars' />)}></DrawerItem>
                ...
                <DrawerItem onPress={() => { router.push('/(drawer)/(tabs)/order') }} label='Settings' icon={(props) => (<DrawerIcon color='olive' name='gear' />)}></DrawerItem>
